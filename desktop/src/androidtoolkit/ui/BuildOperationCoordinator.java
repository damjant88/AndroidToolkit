...
public class BuildOperationCoordinator {
    ...
    public void startInstall(BuildInstallRequest request, BuildOutputLog outputLog, BuildOperationUi ui) {
    ...
    public void startUninstall(BuildUninstallRequest request, BuildOutputLog outputLog, BuildOperationUi ui) {
    ...
    private void startTask(String command, String successMessage, String failMessage, BuildOutputLog outputLog, BuildOperationUi ui) {
        BuildCommandTask task = new BuildCommandTask(command, successMessage, failMessage, outputLog, this, ui);
        task.execute();
    }
